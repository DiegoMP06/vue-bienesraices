...
<template>
    <h2 class="text-center text-h3 my-5 font-weight-bold">Crear Propiedad</h2>
    ...
    >
        ...
        <v-form class="mt-10">
            ...
            <div v-if="image" class="my-5">
                <p class="font-weight-bold align-content-lg-center">Imagen Propiedad: </p>
                
                <img 
                    :src="image" 
                    :alt="`Imagen de la Propiedad ${titulo.value.value}`" 
                    class="w-50"
                />
            </div>
            ...
            <h2 class="font-weight text-center my-5">Ubicacion: </h2>
